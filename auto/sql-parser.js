  ...
  Lexer = (function() {
    ...
    function Lexer(sql, opts) {
      ...
      while (this.chunk = sql.slice(i)) {
        ...
        if (bytesConsumed < 1) {
        	throw{
    			//message : "Missing closing ' " + (this.chunk.slice(0, 1)) + " '",
    ...
    SQL_FUNCTIONS = ['AVG', 'COUNT', 'MIN', 'MAX', 'SUM','ABS'];

    SQL_SORT_ORDERS = ['ASC', 'DESC'];

    SQL_OPERATORS = ['=', '!=', '>=', '>', '<=', '<>', '<', 'LIKE', 'IS NOT', 'IS' ,'BETWEEN'];
        ...
        if (this.defaultActions[state]) {
            ...
            action = table[state] && table[state][symbol];
                ...
                if (lexer.showPosition) {
                    //errStr = 'Parse error on index ' + (yylineno + 1) + ':\n' + lexer.showPosition() + '\nExpecting ' + expected.join(', ') + ', got \'' + (this.terminals_[symbol] || symbol) + '\'';
